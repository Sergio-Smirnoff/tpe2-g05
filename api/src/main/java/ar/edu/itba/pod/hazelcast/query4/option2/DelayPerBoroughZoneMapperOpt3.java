...
public class DelayPerBoroughZoneMapperOpt3 implements Mapper<Integer, TripRowQ42, String, Pair<String, Long>>, HazelcastInstanceAware {
    private transient Map<Integer, ZonesRow> zonesMap;
    private final String desiredBorough;

    public DelayPerBoroughZoneMapperOpt3(String desiredBorough){
